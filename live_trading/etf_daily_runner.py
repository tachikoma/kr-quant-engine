...
_KRX_HOLIDAYS: set[dt.date] = {
    ...
    dt.date(2026, 3, 1),    # 삼일절 (일요일)
    dt.date(2026, 3, 2),    # 삼일절 대체공휴일
    dt.date(2026, 5, 1),    # 근로자의 날
    dt.date(2026, 5, 5),    # 어린이날
    dt.date(2026, 5, 24),   # 부처님오신날 (일요일)
    dt.date(2026, 5, 25),   # 부처님오신날 대체공휴일
    dt.date(2026, 6, 3),    # 전국동시지방선거 (임시공휴일)
    dt.date(2026, 6, 6),    # 현충일 (토요일, 대체공휴일 없음)
    dt.date(2026, 7, 17),   # 제헌절 (2026년부터 공휴일 재지정)
    dt.date(2026, 8, 15),   # 광복절 (토요일)
    dt.date(2026, 8, 17),   # 광복절 대체공휴일
    dt.date(2026, 9, 24),   # 추석 전날
    dt.date(2026, 9, 25),   # 추석
    dt.date(2026, 9, 26),   # 추석 다음날 (토요일)
    dt.date(2026, 10, 3),   # 개천절 (토요일)
